...
const page = () => {
    ...
    return (
        <div className=" container mx-auto w-full ">
            ...
            <div className=" flex flex-row justify-between items-center mb-[60px]">
                <div className=" w-1/5">
                    <p className=" text-[#374151] text-[16px]">About us</p>
